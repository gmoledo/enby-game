	...
	update() {
		if (this.script == "Intro" && this.updateScriptAction) {
			...
			if (this.scriptAction == 10) {
				player.scriptMessage("Okay, mother.", 0);
			}
		...
		if (this.script == "Rhyme" && this.updateScriptAction) {
			...
			if (this.scriptAction == 1) {
				...
				mom.scriptMove(17, 8, 1, 0);
			}

			if (this.scriptAction == 2) {
				mom.scriptMessage("Oh, and the rhyme, sweetie! Don't forget the rhyme!", 0);
			}
		
			if (this.scriptAction == 3) {
				player.scriptMessage("Ugh...", 0);
			}
			...
			if (this.scriptAction == 5) {
				...
				mom.scriptMessage("That's right, honey. See you soon!", 0);
			}
